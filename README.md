...
# Required Data 
DIATAGeR requires two data inputs: a feature list and MS2 spectra. Feature list can be an MS-DIAL alignment file or generic format [[feature list example]](https://shorturl.at/COesX). MS2 spectra can be in txt (peak list exported from MSDIAL), msp and mgf format. 
